export default function Home() {
  return (
    <main className="bg-gray-300 h-screen flex items-center justify-center p-5 dark:bg-gray-500">
      <div className="bg-white shadow-lg p-5 rounded-2xl w-full max-w-screen-sm dark:bg-gray-400">
        ...
        <div className="my-2 flex items-center gap-2">
          <span className="bg-green-400 text-white uppercase px-2 py-1 text-xs font-medium rounded-full hover:scale-125 hover:bg-green-600">
            Today
          </span>
